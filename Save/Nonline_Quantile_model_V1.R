...
#/sample covariates
X <- cbind(rep(1,datalength),matrix(runif((d-1)*datalength), datalength,d-1))
...
target_parameters <- list(quantile=0.5,   prior_mean = theta_star-10,
...
tuning_parameters <- list(N=10000, K=10000,  ESS_bound=0.7, resampling=SSP_Resampling) 
